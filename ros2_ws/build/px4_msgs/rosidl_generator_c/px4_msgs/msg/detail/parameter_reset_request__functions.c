...
{
  px4_msgs__msg__ParameterResetRequest * msg = (px4_msgs__msg__ParameterResetRequest *)malloc(sizeof(px4_msgs__msg__ParameterResetRequest));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__ParameterResetRequest__Sequence__init(px4_msgs__msg__ParameterResetRequest__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__ParameterResetRequest *)calloc(size, sizeof(px4_msgs__msg__ParameterResetRequest));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__ParameterResetRequest__Sequence * array = (px4_msgs__msg__ParameterResetRequest__Sequence *)malloc(sizeof(px4_msgs__msg__ParameterResetRequest__Sequence));
  if (!array) {
    return NULL;
  }
