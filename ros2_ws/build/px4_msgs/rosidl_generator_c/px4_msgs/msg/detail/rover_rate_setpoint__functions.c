...
{
  px4_msgs__msg__RoverRateSetpoint * msg = (px4_msgs__msg__RoverRateSetpoint *)malloc(sizeof(px4_msgs__msg__RoverRateSetpoint));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__RoverRateSetpoint__Sequence__init(px4_msgs__msg__RoverRateSetpoint__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__RoverRateSetpoint *)calloc(size, sizeof(px4_msgs__msg__RoverRateSetpoint));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__RoverRateSetpoint__Sequence * array = (px4_msgs__msg__RoverRateSetpoint__Sequence *)malloc(sizeof(px4_msgs__msg__RoverRateSetpoint__Sequence));
  if (!array) {
    return NULL;
  }
