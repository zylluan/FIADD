...
{
  px4_msgs__msg__ParameterSetUsedRequest * msg = (px4_msgs__msg__ParameterSetUsedRequest *)malloc(sizeof(px4_msgs__msg__ParameterSetUsedRequest));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__ParameterSetUsedRequest__Sequence__init(px4_msgs__msg__ParameterSetUsedRequest__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__ParameterSetUsedRequest *)calloc(size, sizeof(px4_msgs__msg__ParameterSetUsedRequest));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__ParameterSetUsedRequest__Sequence * array = (px4_msgs__msg__ParameterSetUsedRequest__Sequence *)malloc(sizeof(px4_msgs__msg__ParameterSetUsedRequest__Sequence));
  if (!array) {
    return NULL;
  }
