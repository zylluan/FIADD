...
{
  px4_msgs__msg__DatamanResponse * msg = (px4_msgs__msg__DatamanResponse *)malloc(sizeof(px4_msgs__msg__DatamanResponse));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__DatamanResponse__Sequence__init(px4_msgs__msg__DatamanResponse__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__DatamanResponse *)calloc(size, sizeof(px4_msgs__msg__DatamanResponse));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__DatamanResponse__Sequence * array = (px4_msgs__msg__DatamanResponse__Sequence *)malloc(sizeof(px4_msgs__msg__DatamanResponse__Sequence));
  if (!array) {
    return NULL;
  }
