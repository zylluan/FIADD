...
{
  px4_msgs__msg__SensorAirflow * msg = (px4_msgs__msg__SensorAirflow *)malloc(sizeof(px4_msgs__msg__SensorAirflow));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__SensorAirflow__Sequence__init(px4_msgs__msg__SensorAirflow__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__SensorAirflow *)calloc(size, sizeof(px4_msgs__msg__SensorAirflow));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__SensorAirflow__Sequence * array = (px4_msgs__msg__SensorAirflow__Sequence *)malloc(sizeof(px4_msgs__msg__SensorAirflow__Sequence));
  if (!array) {
    return NULL;
  }
