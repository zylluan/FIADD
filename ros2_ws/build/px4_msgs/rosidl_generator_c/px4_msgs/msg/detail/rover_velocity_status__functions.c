...
{
  px4_msgs__msg__RoverVelocityStatus * msg = (px4_msgs__msg__RoverVelocityStatus *)malloc(sizeof(px4_msgs__msg__RoverVelocityStatus));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__RoverVelocityStatus__Sequence__init(px4_msgs__msg__RoverVelocityStatus__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__RoverVelocityStatus *)calloc(size, sizeof(px4_msgs__msg__RoverVelocityStatus));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__RoverVelocityStatus__Sequence * array = (px4_msgs__msg__RoverVelocityStatus__Sequence *)malloc(sizeof(px4_msgs__msg__RoverVelocityStatus__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  px4_msgs__msg__RoverVelocityStatus__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    px4_msgs__msg__RoverVelocityStatus * data =
      (px4_msgs__msg__RoverVelocityStatus *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!px4_msgs__msg__RoverVelocityStatus__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          px4_msgs__msg__RoverVelocityStatus__fini(&data[i]);
        }
        free(data);
        return false;
      }
