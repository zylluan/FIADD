...
static const _OpenDroneIdOperatorId_type_support_symbol_names_t _OpenDroneIdOperatorId_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4_msgs, msg, OpenDroneIdOperatorId)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4_msgs, msg, OpenDroneIdOperatorId)),
  }
};
...
{
  return &::px4_msgs::msg::rosidl_typesupport_cpp::OpenDroneIdOperatorId_message_type_support_handle;
}
