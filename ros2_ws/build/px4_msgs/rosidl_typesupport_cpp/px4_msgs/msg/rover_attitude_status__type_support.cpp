...
static const _RoverAttitudeStatus_type_support_symbol_names_t _RoverAttitudeStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4_msgs, msg, RoverAttitudeStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4_msgs, msg, RoverAttitudeStatus)),
  }
};
...
{
  return &::px4_msgs::msg::rosidl_typesupport_cpp::RoverAttitudeStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, px4_msgs, msg, RoverAttitudeStatus)() {
  return get_message_type_support_handle<px4_msgs::msg::RoverAttitudeStatus>();
}
