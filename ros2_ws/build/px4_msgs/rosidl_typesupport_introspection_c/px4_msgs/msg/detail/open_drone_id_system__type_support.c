...
void OpenDroneIdSystem__rosidl_typesupport_introspection_c__OpenDroneIdSystem_init_function(
...
void OpenDroneIdSystem__rosidl_typesupport_introspection_c__OpenDroneIdSystem_fini_function(void * message_memory)
{
  px4_msgs__msg__OpenDroneIdSystem__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember OpenDroneIdSystem__rosidl_typesupport_introspection_c__OpenDroneIdSystem_message_member_array[13] = {
  {
    "timestamp",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers OpenDroneIdSystem__rosidl_typesupport_introspection_c__OpenDroneIdSystem_message_members = {
  "px4_msgs__msg",  // message namespace
  "OpenDroneIdSystem",  // message name
  13,  // number of fields
  sizeof(px4_msgs__msg__OpenDroneIdSystem),
  OpenDroneIdSystem__rosidl_typesupport_introspection_c__OpenDroneIdSystem_message_member_array,  // message members
  OpenDroneIdSystem__rosidl_typesupport_introspection_c__OpenDroneIdSystem_init_function,  // function to initialize message memory (memory has to be allocated)
  OpenDroneIdSystem__rosidl_typesupport_introspection_c__OpenDroneIdSystem_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t OpenDroneIdSystem__rosidl_typesupport_introspection_c__OpenDroneIdSystem_message_type_support_handle = {
  0,
  &OpenDroneIdSystem__rosidl_typesupport_introspection_c__OpenDroneIdSystem_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4_msgs, msg, OpenDroneIdSystem)() {
  if (!OpenDroneIdSystem__rosidl_typesupport_introspection_c__OpenDroneIdSystem_message_type_support_handle.typesupport_identifier) {
    OpenDroneIdSystem__rosidl_typesupport_introspection_c__OpenDroneIdSystem_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &OpenDroneIdSystem__rosidl_typesupport_introspection_c__OpenDroneIdSystem_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
