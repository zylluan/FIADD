...
#include "my_msg/msg/detail/position__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_msg::msg::Position & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_msg::msg::Position & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
...
{
  auto typed_message =
    static_cast<const my_msg::msg::Position *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_msg::msg::Position *>(
    untyped_ros_message);
...
{
  return &my_msg::msg::typesupport_fastrtps_cpp::_Position__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_msg, msg, Position)() {
  return &my_msg::msg::typesupport_fastrtps_cpp::_Position__handle;
}
