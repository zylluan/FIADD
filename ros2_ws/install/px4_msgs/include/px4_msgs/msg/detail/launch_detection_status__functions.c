...
{
  px4_msgs__msg__LaunchDetectionStatus * msg = (px4_msgs__msg__LaunchDetectionStatus *)malloc(sizeof(px4_msgs__msg__LaunchDetectionStatus));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__LaunchDetectionStatus__Sequence__init(px4_msgs__msg__LaunchDetectionStatus__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__LaunchDetectionStatus *)calloc(size, sizeof(px4_msgs__msg__LaunchDetectionStatus));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__LaunchDetectionStatus__Sequence * array = (px4_msgs__msg__LaunchDetectionStatus__Sequence *)malloc(sizeof(px4_msgs__msg__LaunchDetectionStatus__Sequence));
  if (!array) {
    return NULL;
  }
