...
static rosidl_typesupport_introspection_c__MessageMember GimbalDeviceAttitudeStatus__rosidl_typesupport_introspection_c__GimbalDeviceAttitudeStatus_message_member_array[13] = {
  {
    "timestamp",  // name
