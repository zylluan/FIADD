...
{
  px4_msgs__msg__TiltrotorExtraControls * msg = (px4_msgs__msg__TiltrotorExtraControls *)malloc(sizeof(px4_msgs__msg__TiltrotorExtraControls));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__TiltrotorExtraControls__Sequence__init(px4_msgs__msg__TiltrotorExtraControls__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__TiltrotorExtraControls *)calloc(size, sizeof(px4_msgs__msg__TiltrotorExtraControls));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__TiltrotorExtraControls__Sequence * array = (px4_msgs__msg__TiltrotorExtraControls__Sequence *)malloc(sizeof(px4_msgs__msg__TiltrotorExtraControls__Sequence));
  if (!array) {
    return NULL;
  }
