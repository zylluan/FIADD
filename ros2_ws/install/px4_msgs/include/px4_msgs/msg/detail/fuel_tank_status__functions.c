...
{
  px4_msgs__msg__FuelTankStatus * msg = (px4_msgs__msg__FuelTankStatus *)malloc(sizeof(px4_msgs__msg__FuelTankStatus));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__FuelTankStatus__Sequence__init(px4_msgs__msg__FuelTankStatus__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__FuelTankStatus *)calloc(size, sizeof(px4_msgs__msg__FuelTankStatus));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__FuelTankStatus__Sequence * array = (px4_msgs__msg__FuelTankStatus__Sequence *)malloc(sizeof(px4_msgs__msg__FuelTankStatus__Sequence));
  if (!array) {
    return NULL;
  }
