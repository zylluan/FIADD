...
{
  px4_msgs__msg__CanInterfaceStatus * msg = (px4_msgs__msg__CanInterfaceStatus *)malloc(sizeof(px4_msgs__msg__CanInterfaceStatus));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__CanInterfaceStatus__Sequence__init(px4_msgs__msg__CanInterfaceStatus__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__CanInterfaceStatus *)calloc(size, sizeof(px4_msgs__msg__CanInterfaceStatus));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__CanInterfaceStatus__Sequence * array = (px4_msgs__msg__CanInterfaceStatus__Sequence *)malloc(sizeof(px4_msgs__msg__CanInterfaceStatus__Sequence));
  if (!array) {
    return NULL;
  }
