...
{
  px4_msgs__msg__GeofenceStatus * msg = (px4_msgs__msg__GeofenceStatus *)malloc(sizeof(px4_msgs__msg__GeofenceStatus));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__GeofenceStatus__Sequence__init(px4_msgs__msg__GeofenceStatus__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__GeofenceStatus *)calloc(size, sizeof(px4_msgs__msg__GeofenceStatus));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__GeofenceStatus__Sequence * array = (px4_msgs__msg__GeofenceStatus__Sequence *)malloc(sizeof(px4_msgs__msg__GeofenceStatus__Sequence));
  if (!array) {
    return NULL;
  }
