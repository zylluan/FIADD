...
{
  px4_msgs__msg__FigureEightStatus * msg = (px4_msgs__msg__FigureEightStatus *)malloc(sizeof(px4_msgs__msg__FigureEightStatus));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__FigureEightStatus__Sequence__init(px4_msgs__msg__FigureEightStatus__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__FigureEightStatus *)calloc(size, sizeof(px4_msgs__msg__FigureEightStatus));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__FigureEightStatus__Sequence * array = (px4_msgs__msg__FigureEightStatus__Sequence *)malloc(sizeof(px4_msgs__msg__FigureEightStatus__Sequence));
  if (!array) {
    return NULL;
  }
