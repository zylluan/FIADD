...
{
  px4_msgs__msg__SensorUwb * msg = (px4_msgs__msg__SensorUwb *)malloc(sizeof(px4_msgs__msg__SensorUwb));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__SensorUwb__Sequence__init(px4_msgs__msg__SensorUwb__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__SensorUwb *)calloc(size, sizeof(px4_msgs__msg__SensorUwb));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__SensorUwb__Sequence * array = (px4_msgs__msg__SensorUwb__Sequence *)malloc(sizeof(px4_msgs__msg__SensorUwb__Sequence));
  if (!array) {
    return NULL;
  }
