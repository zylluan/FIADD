...
{
  px4_msgs__msg__ArmingCheckReply * msg = (px4_msgs__msg__ArmingCheckReply *)malloc(sizeof(px4_msgs__msg__ArmingCheckReply));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__ArmingCheckReply__Sequence__init(px4_msgs__msg__ArmingCheckReply__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__ArmingCheckReply *)calloc(size, sizeof(px4_msgs__msg__ArmingCheckReply));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__ArmingCheckReply__Sequence * array = (px4_msgs__msg__ArmingCheckReply__Sequence *)malloc(sizeof(px4_msgs__msg__ArmingCheckReply__Sequence));
  if (!array) {
    return NULL;
  }
