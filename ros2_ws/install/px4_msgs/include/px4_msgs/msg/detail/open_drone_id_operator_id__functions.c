...
{
  px4_msgs__msg__OpenDroneIdOperatorId * msg = (px4_msgs__msg__OpenDroneIdOperatorId *)malloc(sizeof(px4_msgs__msg__OpenDroneIdOperatorId));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__OpenDroneIdOperatorId__Sequence__init(px4_msgs__msg__OpenDroneIdOperatorId__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__OpenDroneIdOperatorId *)calloc(size, sizeof(px4_msgs__msg__OpenDroneIdOperatorId));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__OpenDroneIdOperatorId__Sequence * array = (px4_msgs__msg__OpenDroneIdOperatorId__Sequence *)malloc(sizeof(px4_msgs__msg__OpenDroneIdOperatorId__Sequence));
  if (!array) {
    return NULL;
  }
