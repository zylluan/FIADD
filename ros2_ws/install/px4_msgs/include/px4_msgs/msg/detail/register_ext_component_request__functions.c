...
{
  px4_msgs__msg__RegisterExtComponentRequest * msg = (px4_msgs__msg__RegisterExtComponentRequest *)malloc(sizeof(px4_msgs__msg__RegisterExtComponentRequest));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__RegisterExtComponentRequest__Sequence__init(px4_msgs__msg__RegisterExtComponentRequest__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__RegisterExtComponentRequest *)calloc(size, sizeof(px4_msgs__msg__RegisterExtComponentRequest));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__RegisterExtComponentRequest__Sequence * array = (px4_msgs__msg__RegisterExtComponentRequest__Sequence *)malloc(sizeof(px4_msgs__msg__RegisterExtComponentRequest__Sequence));
  if (!array) {
    return NULL;
  }
