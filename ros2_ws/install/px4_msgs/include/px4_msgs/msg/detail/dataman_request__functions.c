...
{
  px4_msgs__msg__DatamanRequest * msg = (px4_msgs__msg__DatamanRequest *)malloc(sizeof(px4_msgs__msg__DatamanRequest));
  if (!msg) {
    return NULL;
  }
...
px4_msgs__msg__DatamanRequest__Sequence__init(px4_msgs__msg__DatamanRequest__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (px4_msgs__msg__DatamanRequest *)calloc(size, sizeof(px4_msgs__msg__DatamanRequest));
    if (!data) {
      return false;
    }
...
{
  px4_msgs__msg__DatamanRequest__Sequence * array = (px4_msgs__msg__DatamanRequest__Sequence *)malloc(sizeof(px4_msgs__msg__DatamanRequest__Sequence));
  if (!array) {
    return NULL;
  }
