...
bool px4_msgs__msg__open_drone_id_operator_id__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._open_drone_id_operator_id.OpenDroneIdOperatorId", full_classname_dest, 61) == 0);
  }
  px4_msgs__msg__OpenDroneIdOperatorId * ros_message = _ros_message;
  {  // timestamp
  ...
  {  // operator_id
    ...
    }
    {
      ...
      assert(PyArray_TYPE(seq_field) == NPY_UINT8);
      Py_ssize_t size = 20;
      uint8_t * dest = ros_message->operator_id;
      for (Py_ssize_t i = 0; i < size; ++i) {
        uint8_t tmp = *(npy_uint8 *)PyArray_GETPTR1(seq_field, i);
        memcpy(&dest[i], &tmp, sizeof(uint8_t));
      }
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4_msgs__msg__open_drone_id_operator_id__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of OpenDroneIdOperatorId */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._open_drone_id_operator_id");
  ...
  px4_msgs__msg__OpenDroneIdOperatorId * ros_message = (px4_msgs__msg__OpenDroneIdOperatorId *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
  ...
  {  // operator_id
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "operator_id");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    assert(sizeof(npy_uint8) == sizeof(uint8_t));
    npy_uint8 * dst = (npy_uint8 *)PyArray_GETPTR1(seq_field, 0);
    uint8_t * src = &(ros_message->operator_id[0]);
    memcpy(dst, src, 20 * sizeof(uint8_t));
    Py_DECREF(field);
  }
