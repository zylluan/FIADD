...
bool px4_msgs__msg__pure_pursuit_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._pure_pursuit_status.PurePursuitStatus", full_classname_dest, 51) == 0);
  }
  px4_msgs__msg__PurePursuitStatus * ros_message = _ros_message;
  {  // timestamp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4_msgs__msg__pure_pursuit_status__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of PurePursuitStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._pure_pursuit_status");
  ...
  px4_msgs__msg__PurePursuitStatus * ros_message = (px4_msgs__msg__PurePursuitStatus *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
