...
if("${show_ref_output}" MATCHES "refs/remotes/v2.4.2")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v2.4.2")
...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 v2.4.2
  WORKING_DIRECTORY "/home/a/px4_ros_uxrce_dds_ws/build/microxrcedds_agent/microxrcedds_client/src/microxrcedds_client"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/a/px4_ros_uxrce_dds_ws/build/microxrcedds_agent/microxrcedds_client/src/microxrcedds_client/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/a/px4_ros_uxrce_dds_ws/build/microxrcedds_agent/microxrcedds_client/src/microxrcedds_client/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
